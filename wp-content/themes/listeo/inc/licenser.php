...
class Listeo {
  ...
  function action_activate_license(){
    ...
    $api_transient_key = 'listeo_license_check_' . md5($url);
  ...
  function Activated(){
            ...
            $settings['general'] = array(
             'title'                 =>  '<i class="fa fa-sliders-h"></i> General'
          );

          $settings['maps'] = array(
            'title'                 => '<i class="fa fa-map-marked-alt"></i> Map Settings',
          );

          $settings['submit_listing'] = array(
            'title'                 =>  '<i class="fa fa-plus-square"></i> Submit Listing',
          );
          
          $settings['listing_packages'] = array(
            'title'                 =>  '<i class="fa fa-cubes"></i> Packages Options',
          );
          
          $settings['single'] = array(
            'title'                 =>  '<i class="fa fa-file"></i> Single Listing',
          );
          
          $settings['booking'] = array(
            'title'                 =>  '<i class="fa fa-calendar-alt"></i> Booking',
          );
          $settings['browse'] = array(
            'title'                 => '<i class="fa fa-search-location"></i> Browse Listing',
          );

          $settings['registration'] = array(
              'title'                 => '<i class="fa fa-user-friends"></i> Registration',
          );
          
          $settings['pages'] = array(
            'title'                 => '<i class="fa fa-layer-group"></i> Pages',
          );

          $settings['emails'] = array(
            'title'                 => '<i class="fa fa-envelope"></i> Emails', 
          );
        ...
        $html = '<div class="wrap" id="' . $this->slug . '_settings">' . "\n";
            ...
            //$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
                ...
                $html .= '<p class="submit">' . "\n";
                    ...
                    $html .= '<a href="' . $link . '" type="submit" class="button-primary license-deactivate-btn" >Transfer License to Another Domain</a>' . "\n";
                $html .= '</p>' . "\n";
            $html .= '</form></div>' . "\n";
        $html .= '</div>' . "\n";
     ...
     // Build page HTML
        $html = '<div class="wrap" id="' . $this->slug . '_settings">' . "\n";
            ...
            //$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
                ...
                $html .= '<p class="submit">' . "\n";
                    $html .= '<input type="hidden" name="tab" value="' . esc_attr( $tab ) . '" />' . "\n";
                    $html .= '<input name="Submit" type="submit" class="button-primary activate-license-btn" value="' . esc_attr( 'Activate License'  ) . '" />' . "\n";
                $html .= '</p>' . "\n";
            $html .= '</form></div>' . "\n";
        $html .= '</div>' . "\n";
