...
(function ($) {
	...
	function initialize_field( $el )
	{
		...
		var wrapper        = $el,
			...
			canvas         = canvasObj[0],
			input          = wrapper.find( "input.signature-source" ),
			change         = wrapper.find( "input.signature-changed" ),
			signaturePad,
			visible        = false;
		...
		if ( ! sigMobile && typeof canvas != 'undefined' ) {
		...
		*/
		...
		acf.add_action(
			...
			function ( $el ) {
				...
				acf.get_fields( { type : 'form_signature'}, $el ).each(
					function () {
		...
		*/
		...
		$( document ).on(
			...
			function (e, postbox) {
				...
				$( postbox ).find( '.field[data-field_type="form_signature"]' ).each(
					function () {
