jQuery(document).ready(function(){
 ...
 function wp_fm_backup(ajax_url, fm_bkp_database,fm_bkp_files,fm_bkp_plugins,fm_bkp_themes,fm_bkp_uploads,fm_bkp_other,fm_bkp_id){
    jQuery.ajax({
		...
		type : 'post',
		data : {
			action : 'mk_file_manager_pro_backup',
    ...
    if(delarr == '') {
        ...
        if (r == true) {
            jQuery.ajax({
                ...
                url: ajax_url,
                data: {
                        action : 'mk_file_manager_pro_backup_remove',
                        delarr: delarr,
...
jQuery(".dlt_confirmed").click(function () {
    var bkpId = jQuery(this).attr('id')
        jQuery.ajax({
            ...
            url: ajax_url,
            data: {
                    action : 'mk_file_manager_pro_single_backup_remove',
                    id: bkpId,
                    nonce: fmbackupparams.wpfmbackupremove,
                },
            cache: false,
...
jQuery(".bkpViewLog").click(function () {
    ...
    var bkpId = jQuery(this).attr('id')
        jQuery.ajax({
            ...
            url: ajax_url,
            data: {
                    action : 'mk_file_manager_pro_single_backup_logs',
                    id: bkpId,
...
function wp_fm_restore(ajax_url, bkpId,fm_res_database,fm_res_plugins,fm_res_themes,fm_res_uploads,fm_res_other){
    jQuery.ajax({
        ...
        type : 'post',
        data : {
            action : 'mk_file_manager_pro_single_backup_restore',
            id: bkpId,
