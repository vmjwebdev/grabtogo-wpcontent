...
<span class="headingText"><?php _e('Shortcodes','wp-file-manager-pro'); ?></span>
</h3>
<style>
.fm_codeParaTxt .code-well textarea{
    background:#fff;
    width:100%;
...
.fm_codeParaTxt .short-file-code{
    margin-bottom:30px;
}
.fm_codeParaTxt .code-well textarea.single-line{
    height:44px;
}
.fm_codeParaTxt .code-well textarea.multi-line{
    height:64px;
}
</style>
<div class="fm_codeParaTxt">

<div class="short-file-code">
							<h3>Shortcode  of wp file manager admin</h3>
							<p>It will show file manager on front and. You can control all settings 
							from file manager settings. It will work same as backend WP file Manager.</p>
							<div class="code-well">							 
							 <textarea readonly="readonly" class="single-line">[wp_file_manager_admin]</textarea>			
						</div>
						</div>


                        <div class="short-file-code">
							<h3>Shortcode  of wp file manager with parameters</h3>
							<p>Shortcode of wp file manager with required parameters</p>
							<div class="code-well">
							<textarea readonly="readonly" class="multi-line">[wp_file_manager allowed_roles="editor,author" access_folder="wp-content/plugins" write="true" read="faise" hide_files="kumar,abc.php" lock_extensions=".php,.css" allowed_operations="upload,download" ban_user_ids="2,3"]</textarea>	
								
						</div>
						</div>                       

                        <div class="short-file-code">
							<h3>Shortcode of wp file manager with parameters for non logged in users</h3>
							<p>Shortcode of wp file manager with required parameters</p>
							<div class="code-well">
							<textarea readonly="readonly" class="multi-line">[wp_file_manager_without_login view='list' dateformat='d M, Y h:i A' access_folder='wp-content/plugins' write = 'true' read = 'false' hide_files = 'kumar,abc.php' lock_extensions='.php,.css' allowed_operations='upload,download']</textarea>								
							</div>
						</div>
